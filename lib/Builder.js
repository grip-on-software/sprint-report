...
class Builder {
    ...
    makeProjectNavigation(spinner) {
                ...
                .attr('data-tooltip', d => {
                    ...
                    if (_.isArray(d.project_names)) {
                        ...
                        if (!_.isEmpty(_.intersection(
                            _.map(updateList.data(), p => p.name),
                            d.project_names
                        ))) {
                            prefix += "-only";
                        }
                ...
                .attr('href', d => {
                    ...
                    if (d.projects) {
                        ...
                        projects = setToggle(OrderedSet(this.projects.selected),
                            d.name, _.isArray(d.project_names) && _.isEmpty(
                                _.intersection(listNames, d.project_names)
        ...
        if (window.location.hash.startsWith(prefix)) {
            setCurrentItem(window.location.hash.slice(prefix.length));
        }
