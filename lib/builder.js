...
class builder {
    ...
    setPrintTitle() {
        const printTitle = Array.from(this.projects.selected).join(', ');
        d3.select('#print-title').text(printTitle !== "" ?
            this.locales.message('print-title', [printTitle]) :
            this.locales.message('title')
        );
    }
