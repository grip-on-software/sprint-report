...
export default class Format {
    ...
    getProjectUrl(state, project_key) {
        ...
        if (project.component) {
            ...
            return `${config.jira_url}/secure/IssueNavigator.jspa?jqlQuery=project = ${project.project_names}${this.getComponentFilter(component.include)}${this.getComponentFilter(component.exclude, 'not in')}&runQuery=true`;
        }
