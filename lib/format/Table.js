...
export default class Table extends Format {
    ...
    buildDetails(feature_key, icon, sprints, sprint_ids, details) {
        ...
        this.updateDetails(feature_key, sprints, tables, orders);
        sprints.node().scrollIntoView();
    ...
    updateDetails(feature, sprints, tables, sortOrders) {
        ...
        cell.merge(newCell).each((z, i, cells) => {
            ...
            if (!details || !details.format) {
                ...
                details.format(cell, z[1], feature);
            }
        });
    }
}
